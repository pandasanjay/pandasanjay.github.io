      ...
      render={data => {
        ...
        return (
          <SidePanel
            right
            grid={{ md: 3, xl: 2 }}
            className="d-none d-xl-block order-md-12 order-xl-12 border-left border-secondary"
          >
            <h5 className="border-bottom border-dark p-2 font-weight-bold bg-dark text-light shadow">
              SKILLS
            </h5>
            ...
            <h5 className="border-bottom border-dark mt-3 p-2 font-weight-bold bg-dark text-light shadow">
              WORKED AT
            </h5>
            <div className="text-center">
